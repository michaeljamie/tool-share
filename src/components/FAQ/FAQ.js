            ...
            <div className="FAQ-component">
                ...
                <div className="FAQ-questions">
                    <div className="FAQ-individual-questions" onClick={ () => {this.dropDownAnswer('q1Clicked')} }>
                        ...
                        <img className="FAQ-down-arrow" src={this.state.q1Clicked ? "https://www.iconsdb.com/icons/preview/black/arrow-141-xxl.png" : "https://www.iconsdb.com/icons/preview/black/arrow-203-xxl.png"} alt="see_more"/>
                    </div>
                    ...
                    <div className="FAQ-individual-questions" onClick={ () => {this.dropDownAnswer('q2Clicked')} }>
                        ...
                        <img className="FAQ-down-arrow" src={this.state.q2Clicked ? "https://www.iconsdb.com/icons/preview/black/arrow-141-xxl.png" : "https://www.iconsdb.com/icons/preview/black/arrow-203-xxl.png"} alt="see_more"/>
                    </div>
                    ...
                    <div className="FAQ-individual-questions" onClick={ () => {this.dropDownAnswer('q3Clicked')} }>
                        ...
                        <img className="FAQ-down-arrow" src={this.state.q3Clicked ? "https://www.iconsdb.com/icons/preview/black/arrow-141-xxl.png" : "https://www.iconsdb.com/icons/preview/black/arrow-203-xxl.png"} alt="see_more"/>
                    </div>
                    ...
                    <div className="FAQ-individual-questions" onClick={ () => {this.dropDownAnswer('q4Clicked')} }>
                        ...
                        <img className="FAQ-down-arrow" src={this.state.q4Clicked ? "https://www.iconsdb.com/icons/preview/black/arrow-141-xxl.png" : "https://www.iconsdb.com/icons/preview/black/arrow-203-xxl.png"} alt="see_more"/>
                    </div>
