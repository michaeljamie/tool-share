    ...
    render() {
        return (
            <div className="FAQ-component">
                <div className="FAQ-header">New user FAQ</div>
                <div className="FAQ-questions">
                    ...
                    <div className={this.state.q1Clicked ? "answer-displayed" : "answer-not-displayed"}>Answer:  You pay people money to use their tools. You pay people money to use their tools. You pay people money to use their tools. You pay people money to use their tools. You pay people money to use their tools.</div>
